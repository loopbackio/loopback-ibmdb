...
Thank you for your interest in `loopback-connector-ibmdb`, an open source project
administered by StrongLoop (an IBM Company).

Contributing to `loopback-connector-ibmdb` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-connector-ibmdb)
