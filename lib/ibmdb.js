...
function IBMDB(name, settings) {
  ...
  this.connectionOptions.minPoolSize = parseInt(settings.minPoolSize) || 0;
  this.connectionOptions.maxPoolSize = parseInt(settings.maxPoolSize) || 0;
  this.connectionOptions.connectionTimeout = parseInt(settings.connectionTimeout) || 60;
